                       ...
                       <div class="col-md-12">
                           <form wire:submit.prevent="AddNewUser">
                               <div class="row">
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           <label for="password" class="label-control">password<b class="text-danger">*</b></label>
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label class="label-control">UType <b class="text-danger">*</b></label>
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           ...
                                           <input type="file" name="profile_photo_path" id="profile_photo_path" class="form-control" wire:model="profile_photo_path">
                                       </div>
                                   </div>
                                   <div class="col-md-12">
